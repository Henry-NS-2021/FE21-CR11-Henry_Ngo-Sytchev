...
--
-- Host: 127.0.0.1
-- Erstellungszeit: 13. Jan 2022 um 21:22
...
(2, 'Josie', 'Chartreux Cat', 'chartreux.jpg', 'Am Tabor 2/12', 'In 1920, a pair of siblings began breeding Chartreux cats in France. Breeding faced many difficulties during the war. British Shorthair or Russian Blue cats were often crossbred. As a result, the Carthusian gene pool was “watered down”. Nowadays, breeders pay close attention to the fact that the Carthusians have the characteristics typical of their breed. It was not until 1977 that the Carthusian cat or Chartreux was officially recognized as an independent cat breed.', 21, 1, 'Spying on neighbours'),
...
(40, 'Random Dog', 'Rockie', 'animal.png', 'testirovanie', '', 3, 3, 'Running wild');
...
CREATE TABLE `pet_adoption` (
  ...
  `status` enum('adopted') DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE `users` (
  ...
  `user_status` varchar(4) NOT NULL DEFAULT 'user'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
(1, 'Gerald', 'Holmes', 'gholmes@mail.at', 675602558, 'Passeti Strasse 32/2/8', 'avatar.png', '96cae35ce8a9b0244178bf28e4966c2ce1b8385723a96a6b838858cdd6ca0a1e', 'adm'),
(2, 'Helmut', 'Kohler', 'hkohler@mail.at', 660502165, 'Handelskai 9/4/36', 'avatar.png', '96cae35ce8a9b0244178bf28e4966c2ce1b8385723a96a6b838858cdd6ca0a1e', 'adm'),
...
(12, 'John', 'Wick', 'jw@user.com', 2147483647, 'none', 'avatar.png', '96cae35ce8a9b0244178bf28e4966c2ce1b8385723a96a6b838858cdd6ca0a1e', 'adm'),
(13, 'Harry', 'Potter', 'hp@magic.mg', 754568945, 'Hogwards Northern Tower, 4th Floor', '61d6f0882b76f.jpg', '96cae35ce8a9b0244178bf28e4966c2ce1b8385723a96a6b838858cdd6ca0a1e', 'adm');
...
--
ALTER TABLE `animals`
  MODIFY `animal_id` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=57;

--
-- AUTO_INCREMENT für Tabelle `pet_adoption`
--
ALTER TABLE `pet_adoption`
  MODIFY `adoption_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=72;
