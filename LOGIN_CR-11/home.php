...
<div class="row alert-warning bg-muted m-0">
            <p class="bg-dark text-light text-end">
            <span class="text-warning"> Here you can...</span>
            <a class="text-decoration-none text-light" href="update.php?id=<?php echo $_SESSION['user'] ?>">Update your profile</a> 
            <span class="text-warning"> | </span>
            <a class="text-decoration-none text-light" href="logout.php?logout">Sign Out</a>
            </p>
