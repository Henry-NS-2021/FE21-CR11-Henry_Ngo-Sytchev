    ...
    if($_GET["id"]){
        ...
        if(mysqli_num_rows($query) == 1){
            ...
            foreach($result as $data){
                ...
                <article class='my-3 mx-5 card h-50'>
                    <div class='card-body row'>
                        <div class='col-sm-12 col-md-5'>
                            <img class='img-fluid' src='../pictures/" .$data["picture"] . "'>
                        </div>
                        <div class='col-sm-12 col-md-7'>
                            <h1 class='card-title display-2 fw-bold mt-3 mb-4 text-center'>{$data['name']} </h1>
                    ...
                    <form class='m-0 p-0' action='actions/a_delete.php' method='POST'>
                        ...
                        <p class='text-center m-0'>
                            <button class='btn btn-lg btn-danger py-0 px-3 mx-2' type='submit'>YES, please</button>
                            <a href='index.php'><span class='btn btn-lg btn-primary py-0 px-3 mx-2'>NO, keep it</span></a>
                    </div>
                        </p>
                    </form> 
