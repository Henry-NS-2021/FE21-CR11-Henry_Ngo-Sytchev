...
if(mysqli_num_rows($query_animals) > 0){
    foreach($result as $row){
        ...
        <tr class='align-middle text-center border-top border-bottom border-secondary'>
            ...
            <td class='text-center'>
            <a class='btn btn-outline-secondary w-auto py-0' href='animals/details.php?id={$row['animal_id']}'><span>Show more</span></a>
            <a class='btn btn-outline-secondary w-auto py-0' href='animals/update.php?id={$row['animal_id']}'><span>Update</span></a>
            <a class='btn btn-outline-secondary w-auto py-0' href='animals/delete.php?id={$row['animal_id']}'><span>Delete</span></a>
            </td>
        </tr>
        ";
    }
       ...
       <div class="row border border-info border-3 alert alert-info mb-5">
            ...
            <p class="bg-dark text-light text-end pb-2">
               <sub>
                  ...
                  <a class="text-decoration-none text-info mx-2" href="update.php?id=<?php echo $_SESSION['adm'] ?>">Update your profile</a> 
